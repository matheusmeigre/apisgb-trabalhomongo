...
async function resetCollections() {
  try {
    ...
    for (const collection of collections) {
      ...
      console.log(`Removendo collection: ${collectionName}`);
    ...
    console.log("Todas as collections estão agora vazias e prontas para uso.");
  } catch (error) {
...
console.log("ATENÇÃO: Este script irá APAGAR TODOS OS DADOS das collections!");
console.log("");
